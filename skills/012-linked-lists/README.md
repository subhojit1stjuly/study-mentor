...
**Skill ID**: 012-linked-lists
**Created**: 2026-06-12

## Description

Master linked list manipulation, pointer techniques, cycle detection, and reversal
...
1. **Morning (1h)**: Study concepts in teach_me
   - Location: `D:\Projects\ShowCase\agentAi\teach_me\skills\012-linked-lists\roadmap.md`
...
# Review: skills/012-linked-lists/modules.md
...
# Update progress
cd D:\Projects\ShowCase\agentAi\teach_me
# Edit: skills/012-linked-lists/progress.json
```
